                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex justify-center items-center p-8">
                            <div class="w-40 h-40 bg-stone-400 rounded-xl flex justify-center items-center" id="book-box">
                                <i class="fa-solid fa-plus"></i>
                            </div>
                        </div>

                        <form action="save-book.do" method="post" enctype="multipart/form-data">
                            ...
                            <div
                                ...
                                <div class="px-4 py-2 bg-white rounded-lg dark:bg-gray-800">
                                    <label for="book-title" class="sr-only">About The Book</label>
                                    <input type="text" id="book-title" rows="4"
                                        class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
                                        placeholder="Book's Title..." required name="title">
                                </div>

                                <div class="px-4 py-2 mt-2 bg-white rounded-lg dark:bg-gray-800">
                                    <label for="book-desc" class="sr-only">About The Book</label>
                                    <textarea id="book-desc" rows="4"
                                        class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
                                        placeholder="Write about the book..." required name="description" ></textarea>
                                </div>

                                <div class="px-4 py-2 mt-2 bg-white rounded-lg dark:bg-gray-800">
                                    <label for="book-price" class="sr-only">Book Price</label>
                                    <input id="book-price" rows="4"
                                        class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
                                        placeholder="Enter the book price..." required name="price" >
                                </div>

                                <div class="px-4 py-2 mt-2 bg-white rounded-lg dark:bg-gray-800">
                                    <label for="book-genre" class="sr-only">Book Genre</label>
                                    <!-- <select id="book-genre" rows="4"
                                        class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
                                        placeholder="Enter the book price..." required />
                                            <option value=""></option>
                                    </select> -->
                                    <select
                                        class="fw-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" name="book-genre">
                                        <option id="0" disabled>Select A Genre</option>
                                        <c:forEach var="genreF" items="${genres}">


                                            <option id='<c:out value="${genreF.genreId}" />'
                                                value='<c:out value="${genreF.genreId}" />'  class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded
                                                focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800
                                                focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                <c:out value="${genreF.name}" />
                                            </option>
                            ...
                            <div class="h-[100%]">
                                <div
                                    ...
                                    <div class="flex justify-around items-center flex-col h-[20%]">
                                        ...
                                        <button type="button" data-modal-target="book-modal"
                                            data-modal-toggle="book-modal"
